...
Compile the interactive 3D raylib visualization:
...
/private/tmp/cislunar_nav_3d_viz
```

Controls:

- `1`: lunar proximity operations
- `2`: weak-geometry stress case
- `3`: high-uncertainty recovery case
- `SPACE`: pause/resume
- `F` or `F11`: toggle fullscreen
- `R`: reset current scenario
- Mouse/trackpad: orbit camera and zoom
