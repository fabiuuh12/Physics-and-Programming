...
This project is best presented as a scientific visualization and simulation portfolio. It is not a certified computational physics analysis tool. Its value is in translating physics concepts into interactive software, building real-time visual systems, and showing enough mathematical and engineering discipline to discuss assumptions clearly.
...
3. Open one computational physics-focused source file:
...
- Add one-page technical notes for the highest-value computational physics simulations.
