...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        studio::title("Particle Accelerator: Circular Motion in Magnetic Field", studio::Style::Quantum);
        studio::help("Hold left mouse: orbit | wheel: zoom | [ ] B-field | +/- speed | P pause | R reset");
