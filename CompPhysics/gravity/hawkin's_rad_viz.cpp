...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        studio::title("Hawking Radiation: Higher Temperature for Smaller Mass", studio::Style::Observatory);
        studio::help("Hold left mouse: orbit | wheel: zoom | [ ] black hole mass | P pause | R reset");
