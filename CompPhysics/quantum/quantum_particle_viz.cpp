...
std::optional<LiveControls> LoadLiveControls() {
    ...
    const std::vector<std::filesystem::path> candidates = {
        ...
        "../vision/live_controls.txt",
        "../../vision/live_controls.txt",
        "CompPhysics/vision/live_controls.txt",
...
int main() {
    ...
    std::string controlStatus = "bridge: waiting for CompPhysics/vision/live_controls.txt";
    ...
    while (!WindowShouldClose()) {
        ...
        controlStatus = "bridge: waiting for CompPhysics/vision/live_controls.txt";
