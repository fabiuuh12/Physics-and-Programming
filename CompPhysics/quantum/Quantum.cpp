...
int main() {
    ...
    while (!WindowShouldClose()) {
        ...
        studio::title("Quantum States in a Potential (Conceptual)", studio::Style::Quantum);
        studio::help("Hold left mouse: orbit | wheel: zoom | [ ] quantum state n | +/- potential depth | P pause | R reset");
